...
export const PROJECTS = [
  ...
  },
  {
    ...
    context: "In the spring of 2026, I took a class called User Interface Design taught by professor Celeste Layne. For our midterm, I built a Flask-based personal music catalog, titled “bàbájídé's library.”",
  ...
  },
  {
    ...
    categories: ["community", "graphic-design"],
    year: "2025",
    thumbnail: publicAsset("work/mae-bacchanal-thumb.jpg"),
    context: "The Morningside Art Exchange (also known as MAE) is a grassroots, student-led arts collective that brings together student artists and local residents. We have our titular event, the Morningside Art Exchange, quarterly at nearby parks and operate on a barter-and-donation model. We also sell merchandise that we design ourselves.",
    ...
    processImages: [
      publicAsset("work/mae-bacchanal-process-1.jpg"),
      publicAsset("work/mae-bacchanal-process-2.jpg"),
      publicAsset("work/mae-bacchanal-process-3.jpg"),
      publicAsset("work/mae-bacchanal-process-4.jpg"),
    ],
  },
  {
    id: 8,
  ...
  },
  {
    ...
    thumbnail: null,
    flipbookImages: [
      publicAsset("work/decision-day-flip-1.jpg"),
    ...
    processImages: [
      publicAsset("work/decision-day-process-1.jpg"),
      publicAsset("work/decision-day-process-2.jpg"),
      publicAsset("work/decision-day-process-3.jpg"),
      publicAsset("work/decision-day-process-4.jpg"),
    ],
  },
  {
    id: 10,
